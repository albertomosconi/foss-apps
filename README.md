...
- [![Gitlab Stars](https://img.shields.io/badge/dynamic/json?label=★&query=%24.star_count&url=https%3A%2F%2Fgitlab.com%2Fapi%2Fv4%2Fprojects%2F6922885)
  **Aurora Store**](https://gitlab.com/AuroraOSS/AuroraStore "Aurora Store") ( [website](https://auroraoss.com/app_info.php?app_id=1 "website") ) ( [f-droid](https://f-droid.org/en/packages/com.aurora.store "f-droid") ) An alternate to Google's Play Store, with an elegant design, using Aurora you can download apps, update existing apps, search for apps, get details about in-app trackers, spoof your location and much more.
...
- [![GitHub stars](https://img.shields.io/github/stars/rkkr/simple-keyboard.svg?label=★&style=flat)
  **Simple Keyboard**](https://github.com/rkkr/simple-keyboard "Simple Keyboard"): This keyboard is created for those who only need a keyboard and nothing more, it is very simple and lightweight, with minimal permissions required and zero ads.
